            ...
            >
                ...
                <div class="d-flex justify-content-center">
                    <div class="col-11 mt-3">
                        <p class="lead m-3 text-lg" align="justify">
                                        ...
                                        <td
                                            v-if="
                                                test.reference_range
                                                    ...
                                                    'CUANTITATIVO'
                                            "
                                            class="text-success text-md text-bold"
                                        >
                                            {{
                                                test.reference_range
                                                    .normal_minimum
                ...
                <h4 id="sample">
                    <i class="fas fa-syringe text-info ml-3"></i
                    ><span class="text-info ml-3"
                        >INFORMACIÓN TOMA DE MUESTRA</span
                    >
                </h4>
                <div class="d-flex justify-content-center">
                    <div class="col-11 mt-3">
                        ...
                        <div class="info-box">
                            <span
                                ...
                                class="info-box-icon"
                                ><i
                                    class="fas fa-square fa-lg elevation-3"
                ...
                <h4 id="laboratory">
                    <i class="fas fa-microscope text-info ml-3"></i
                    ><span class="text-info ml-3">INFORMACIÓN LABORATORIO</span>
                </h4>
                <div class="d-flex justify-content-center">
                    <div class="col-11 mt-3">
                        <h5>LOINC</h5>
                        <div class="info-box">
                            <span
                                style="min-width: 100px;"
                                class="info-box-icon bg-gradient-info text-lg"
                            >
                                {{ loinc.loinc_num }}</span
                            >
                            <div class="info-box-content">
                                <span class="info-box-number text-lg">{{
                        ...
                        <div class="info-box">
                            <span
                                ...
                                class="info-box-icon bg-gradient-info text-lg"
                            >
                                {{ fonasa_test.code }}</span
                            >
                            <div class="info-box-content">
                                <span class="info-box-number text-lg">{{
                                    fonasa_test.description
                                }}</span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="info-box">
                                    <span
                                        style="min-width: 100px;"
                                        class="info-box-icon bg-gradient-success text-lg"
                                    >
                                        {{ loinc.loinc_num }}</span
                                    >
                                    <div class="info-box-content">
                                        <span class="info-box-number text-lg">
                                            {{ analyte.description }}</span
                                        >
                                        <span class="info-box-text text-lg"
                                            ><span
                                                class="lead mr-3 text-success text-bold"
                                                >Sistema OA (SME HHHA)
                                            </span></span
                                        >
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-box">
                                    <span
                                        ...
                                        class="info-box-icon bg-gradient-info text-lg"
                                    >
                                        {{ hca.internal_code }}</span
                                    >
                                    <div class="info-box-content">
                                        <span class="info-box-number text-lg">
                                            {{ hca.description }}</span
                                        >
                                        <span class="info-box-text text-lg"
                                            ><span
                                                class="lead mr-3 text-info text-bold"
                                                >Sistema Infinity
                                            </span></span
                                        >
                                    </div>
