                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select v-model="state_id" id="state_id_save" class="custom-select" :class="checkState">
                                    ...
                                    <option v-for="state in selectState" :value="state.id" :key="state.id">{{ state.description }}
                                    </option>
                                </select>
                            </div>
                        </div>
        ...
        methods: {
            ...
            save(e) {
                ...
                if (this.validateInput()) {
                    ...
                    axios.post('/api/available', params)
                        .then(res => {
                            toast.fire({
                                icon: 'success',
            ...
            edit(e) {
                ...
                if (this.validateInput()) {
                    ...
                    axios.put(`/api/available/${this.id}`, params)
                        .then(res => {
            ...
            destroy(item, index) {
                swal.fire({
                    ...
                    if (result.value) {
                        axios.delete(`/api/available/${item.id}`)
                            .then(res => {
                                toast.fire({
                                    icon: 'success',
