<template>
    <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <select v-model="state_id" class="custom-select" :class="checkState"
        ...
        <div class="card mt-2">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <table id="tableSection" class="table table-bordered table-hover table-sm">
                    <thead>
                    <tr>
            ...
            <div class="card-footer clearfix">
                <ul class="pagination pagination-sm m-0 float-right">
                    ...
                    <li v-for="(page, index) in (meta.last_page)" :key="index" class="page-item"><a class="page-link"
    ...
    export default {
        ...
        methods: {
            ...
            edit(e) {
                ...
                axios.patch(`/admin/section/${this.id}`, params)
                    .then(res => {
            ...
            destroy(item, index) {
                swal.fire({
                    ...
                    if (result.value) {
                        axios.delete(`/admin/section/${item.id}`)
                            .then(res => {
                                toast.fire({
                                    icon: 'success',
            ...
            getPage(index) {
                axios.get('/api/section?page=' + (index))
                    .then(response => {
                        this.items = response.data.data
            ...
            firstPage() {
                axios.get('/api/section' + this.links.next)
                    .then(response => {
                        this.items = response.data.data
                        console.log(response)
                        this.links = response.data.links
            ...
            lastPage() {
                axios.get('/api/section' + this.links.last)
                    .then(response => {
                        this.items = response.data.data
                        console.log(response)
                        this.links = response.data.links
            ...
            prevPage() {
                axios.get('/api/section' + this.links.prev)
                    .then(response => {
                        this.items = response.data.data
                        console.log(response)
                        this.links = response.data.links
