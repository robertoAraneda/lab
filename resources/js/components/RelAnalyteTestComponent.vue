        ...
        <div v-if="contentReady">
            <div v-if="formContent" class="card mt-2 card-secondary">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-md-8">
                            <div class="form-group">
                                <label>Examen: </label>
                                <select2 v-if="analytes.length" :options="analytes" v-model="selectedAnalyte"
                                ></select2>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4">
                            <div class="form-group">
                                <label>Estado: </label>
                                <select2 v-if="states.length" :options="states" v-model="selectedState"
                                ></select2>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    <div class="input-group">
                                        <input v-model="search_test" type="text" class="form-control"
                                               placeholder="Buscar">
                                    ...
                                    <div class="list-group list-group-flush overflow-auto">
                                        <button @dblclick.prevent="selectTest(test)" v-for="test in filteredList"
                        ...
                        <div class="col-sm-7 col-md-7 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div v-for="(selectedTest, index) in selectedTests" :key="selectedTest.id"
                                             class="col-md-12 col-sm-12 col-12">
                                            <div class="info-box">
                                                <div class="info-box-content overflow-hidden">
                                                    <span class="info-box-text"><strong>{{ (index+1 +".  ") }}</strong>{{ selectedTest.description }}</span>
                                                </div>
                                                <button @click="removeSelected(selectedTest)"
                                                        class=" btn btn-info info-box-icon"><i class="fas fa-times"></i>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card-footer bg-white">
                    ...
                    <button v-if="editing" @click.prevent="edit" type="submit" class="btn btn-warning float-right ml-2">
                        Editar
                    </button>
                    ...
                    <table class="table table-hover table-sm">
                        ...
                        <td class="text-center py-1 align-middle">
                            <div class="btn-group btn-group-sm">
                                ...
                                <button class="btn btn-danger mx-1" href="#" @click.prevent="destroy(item)"><i
        ...
        computed: {
            filteredList: function () {
                return this.tests.filter((test) => {
                    return test.description.toLowerCase().match(this.search_test.toLowerCase()) && test.selected == false;
                })
            },
            filterData() {
                const filtered = this.analyteTests.filter((analyteTest) => {

                    return analyteTest.analyte.description.toLowerCase().match(this.search_item.toLowerCase());
        ...
        methods: {
            ...
            save: function () {
                if (this.validateInput()) {
                    ...
                    const response = axios.post('/api/analyteTest', params)
                        .then(response => {
                            toast.fire({
                                icon: 'success',
            ...
            setEdit(item) {
                ...
                this.selectedTests = this.tests.map(test => {
            ...
            edit() {
                ...
                const response = axios.put(`/api/analyteTest/${this.selectedAnalyte}`, params)
                    .then(response => {
                        toast.fire({
                            icon: 'success',
            ...
            destroy(item) {
                swal.fire({
                    ...
                    if (result.value) {
                        const response = axios.delete(`/api/analyteTest/${item.analyte.id}`)
                            .then(response => {
                                toast.fire({
                                    icon: 'success',
