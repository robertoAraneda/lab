                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            id="description"
                                            v-model="infinitySample.description"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label
                                            v-if="
                                                infinitySample.abbreviature ===
                                                    ''
                                            "
                                            >&nbsp;</label
                                        >
                                        <label for="abbreviature" v-else
                                            >NOMBRE CORTO:</label
                                        >
                                        <input
                                            id="abbreviature"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label
                                            v-if="infinitySample.state.id === 0"
                                            >&nbsp;</label
                                        >
            ...
            <div class="card mt-2">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-sm">
                        ...
                        <tbody
                            v-for="infinitySample in setPaginate"
                            :key="infinitySample.id"
                        >
            ...
            if (this.validateInput()) {
                ...
                try {
                    ...
                    if (updateResponse.status === 200) {
                        ...
                        const index = this.collections.infinitySamples.findIndex(
                            find => find.id === json.infinitySample.id
                        )

                        this.collections.infinitySamples.splice(
                            index,
                            1,
                            json.infinitySample
                        )
