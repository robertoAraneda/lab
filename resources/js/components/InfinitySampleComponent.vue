                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input v-model="abbreviature" id="abbreviature_save" :class="checkAbbreviature" type="text"
                                       class="form-control"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="abbreviature_save">Nombre corto</label>
                                <input v-model="abbreviature" id="abbreviature_edit" :class="checkAbbreviature" type="text"
                                       class="form-control"
                                       placeholder="Nombre corto"
                                >
                            </div>
        ...
        methods: {
            ...
            save(e) {
                ...
                if (this.validateInput()) {
                    ...
                    console.log(params)
                    axios.post('/api/infinitySample', params)
                        .then(res => {
                            console.log(res)
                            toast.fire({
                                icon: 'success',
            ...
            edit(e) {
                ...
                if(this.validateInput()){
                    ...
                    console.log(params)
                    axios.put(`/api/infinitySample/${this.id}`, params)
                        .then(res => {
                            ...
                            this.items[index].abbreviature = res.data.abbreviature
            ...
            setEdit(item) {
                this.editing = true;
                this.abbreviature = item.abbreviature
            ...
            destroy(item, index) {
                swal.fire({
                    ...
                    if (result.value) {
                        axios.delete(`/api/infinitySample/${item.id}`)
                            .then(res => {
                                toast.fire({
                                    icon: 'success',
            ...
            validateInput() {
                if (this.state_id == 0 || this.description == '' || this.abbreviature == '') {
