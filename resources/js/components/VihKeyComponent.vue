                        ...
                        <td class="text-center py-1 align-middle">
                            <div class="btn-group btn-group-sm">
                                <span class="d-inline-block" tabindex="0" data-toggle="tooltip"
                                      title="Ver detalle">
                                         <a class="btn btn-info mx-1" href="#"><i class="fas fa-eye"></i></a></span>
                                <span class="d-inline-block" tabindex="0" data-toggle="tooltip"
        ...
        methods: {
            ...
            edit(e) {
                ...
                if (this.validateInput()) {
                    ...
                    axios.put(`/api/vihkey/${this.id}`, params)
                        .then(res => {
            ...
            destroy(item, index) {
                swal.fire({
                    ...
                    if (result.value) {
                        axios.delete(`/api/vihkey/${item.id}`)
                            .then(res => {
                                toast.fire({
                                    icon: 'success',
