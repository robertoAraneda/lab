                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="abbreviation_save">Nombre corto</label>
                                <input v-model="abbreviation" id="abbreviation_save" :class="checkAbbreviation" type="text"
                                       class="form-control"
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <input v-model="abbreviation" id="abbreviation_edit" :class="checkAbbreviation" type="text"
                                       class="form-control"
                                       placeholder="Nombre corto"
                                >
                            </div>
        ...
        methods: {
            ...
            save(e) {
                ...
                if (this.validateInput()) {
                    ...
                    console.log(params)
                    axios.post('/api/container', params)
                        .then(res => {
                            console.log(res)
                            toast.fire({
                                icon: 'success',
            ...
            edit(e) {
                ...
                if(this.validateInput()){
                    ...
                    console.log(params)
                    axios.put(`/api/container/${this.id}`, params)
                        .then(res => {
            ...
            destroy(item, index) {
                swal.fire({
                    ...
                    if (result.value) {
                        axios.delete(`/api/container/${item.id}`)
                            .then(res => {
                                toast.fire({
                                    icon: 'success',
