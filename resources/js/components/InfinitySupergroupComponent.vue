                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <label
                                            v-if="
                                                infinitySupergroup.description ===
                                                    ''
                                            "
                                            >&nbsp;</label
                                        >
            ...
            <div class="card mt-2">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-sm">
                        ...
                        <tbody
                            v-for="infinitySupergroup in setPaginate"
                            :key="infinitySupergroup.id"
                        >
                            ...
                            <td>
                                <span
                                    :class="
                                        infinitySupergroup.state.id === 1
                                            ? 'badge badge-success'
                                            : 'badge badge-danger'
                                    "
                                >
                                    {{
                                        infinitySupergroup.state.description
                                    }}</span
                                >
                            </td>
        ...
        async save() {
            if (this.validateInput()) {
                ...
                if (saveResponse.status === 200) {
                    ...
                    this.collections.infinitySupergroups.push(
                        json.infinitySupergroup
                    )
                    toast.fire({
                        icon: 'success',
            ...
            if (this.validateInput()) {
                ...
                try {
                    ...
                    if (updateResponse.status === 200) {
                        ...
                        const index = this.collections.infinitySupergroups.findIndex(
                            find => find.id === json.infinitySupergroup.id
                        )

                        this.collections.infinitySupergroups.splice(
                            index,
                            1,
                            json.infinitySupergroup
                        )
