                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label
                                            v-if="
                                                infinityTypeTube.infinitySample
                                                    .id === 0
                                            "
                                            >&nbsp;</label
                                        >
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label
                                            v-if="
                                                infinityTypeTube.infinityLabel
                                                    .id === 0
                                            "
                                            >&nbsp;</label
                                        >
            ...
            <div class="card mt-2">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-hover table-sm">
                        ...
                        <tbody
                            v-for="infinityTypeTube in setPaginate"
                            :key="infinityTypeTube.id"
                        >
                            ...
                            <td>
                                {{
                                    infinityTypeTube.infinity_sample.description
                                }}
                            </td>
                            <td v-if="infinityTypeTube.label !== null">
                                {{ infinityTypeTube.label.code }}
                            </td>
                            <td v-else>-</td>
                            <td>
                                <span
                                    :class="
                                        infinityTypeTube.state.id === 1
                                            ? 'badge badge-success'
                                            : 'badge badge-danger'
                                    "
                                >
                                    {{
                                        infinityTypeTube.state.description
                                    }}</span
                                >
                            </td>
...
export default {
    ...
    computed: {
        ...
        filterData() {
            return this.collections.infinityTypeTubes.filter(
                infinityTypeTube => {
    ...
    methods: {
            ...
            if (this.validateInput()) {
                ...
                try {
                    ...
                    if (response.status >= 200 && response.status < 300) {
                        const json = await response.json()
                        this.collections.infinityTypeTubes.push(
                            json.infinityTypeTube
                        )
                        toast.fire({
                            icon: 'success',
            ...
            if (this.validateInput()) {
                ...
                try {
                    ...
                    if (response.status >= 200 && response.status < 300) {
                        ...
                        const index = this.collections.infinityTypeTubes.findIndex(
                            find => find.id === this.id
                        )

                        console.log(json)
                        this.collections.infinityTypeTubes.splice(
                            index,
                            1,
                            json.infinityTypeTube
                        )
        ...
        setEdit(selected) {
            ...
            this.infinityTypeTube.infinitySample.id =
                selected.infinity_sample.id
