                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select v-model="state_id" id="state_id_edit" class="custom-select"
                                        :class="checkState">
                                    <option value="0">Seleccione:</option>
                                    <option v-for="state in selectState" :value="state.id">{{ state.description }}
                                    </option>
        ...
        methods: {
            ...
            edit(e) {
                ...
                if (this.validateInput()) {
                    ...
                    console.log(params)
                    axios.put(`/api/label/${this.id}`, params)
                        .then(res => {
            ...
            destroy(item, index) {
                swal.fire({
                    ...
                    if (result.value) {
                        axios.delete(`/api/label/${item.id}`)
                            .then(res => {
                                toast.fire({
                                    icon: 'success',
