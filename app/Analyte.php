...
class Analyte extends Model
{
  ...
  public function quantitySamplePediatric()
  {
    return $this->belongsTo(QuantitySample::class, 'quantity_sample_pediatric_id');
  }

  public function quantitySampleAdult()
  {
    return $this->belongsTo(QuantitySample::class, 'quantity_sample_adult_id');
  }
