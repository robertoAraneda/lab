...
class InfinityRelGroupTestController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $infinityGroupController = new InfinityGroupController();

        $relGroupTest = InfinityRelGroupTest::find($id);

        $relGroupTest->infinity_group_id = $infinityGroupController->show($relGroupTest->infinity_group_id);
        $relGroupTest->infinity_test_id = $infinityTestController->show($relGroupTest->infinity_test_id);
